...
if (skillInput) {
  ...
  const SKILLS = [
    ...
    { n: 'ANSYS', c: 'CAD', alt: 'fea finite element analysis simulation', u: [E('Certifications','certifications.html')] },
    ...
    { n: 'Design for Manufacturability', c: 'Manufacturing', alt: 'dfm dfma manufacturability producibility cost reduction tooling setup reduction machinability', u: [E('Rochester Sensors','experiences/rochester-sensors.html'),E('ECOFIL','experiences/ecofil.html')] },
    { n: 'Workholding & Fixture Design', c: 'Manufacturing', alt: 'fixture jig workholding repeatability locating multi part', u: [E('Rochester Sensors','experiences/rochester-sensors.html')] },
    ...
    { n: 'Industrial Robotics (Universal Robots)', c: 'Manufacturing', alt: 'cobot collaborative robot ur robotiq gripper automation bin picking factory', u: [E('Bin Picking','experiences/rochester-robot-cell.html')] },
    { n: 'Machine Vision (Keyence 3D)', c: 'Manufacturing', alt: 'vision system point cloud 3d search path planning depth map automation', u: [E('Bin Picking','experiences/rochester-robot-cell.html')] },
    ...
    { n: 'Python', c: 'Programming', alt: 'scripting programming language', u: [E('CUDA CFD','experiences/cfd-optimization.html'),E('RoomCleaner','experiences/roomcleaner.html')] },
    { n: 'Computer Vision (YOLO, OpenCV)', c: 'Programming', alt: 'object detection camera perception yolo world opencv homography', u: [E('RoomCleaner','experiences/roomcleaner.html')] },
    ...
    { n: 'Arduino', c: 'Electronics', alt: 'microcontroller nano embedded', u: [E('ECOFIL','experiences/ecofil.html'),E('Bike Lock','experiences/bike-lock.html'),E('RoomCleaner','experiences/roomcleaner.html')] },
    { n: 'ESP32 & Wireless Control', c: 'Electronics', alt: 'esp32 wifi wireless embedded microcontroller end effector', u: [E('RoomCleaner','experiences/roomcleaner.html')] },
    { n: 'Stepper Motor Control', c: 'Electronics', alt: 'stepper a4988 cnc shield step dir driver motor sizing limit switch homing', u: [E('RoomCleaner','experiences/roomcleaner.html'),E('ECOFIL','experiences/ecofil.html')] },
    { n: 'Sensors & Instrumentation', c: 'Electronics', alt: 'hall effect thermistor hygrometer', u: [E('ECOFIL','experiences/ecofil.html')] },
    { n: 'RFID / NFC (PN532)', c: 'Electronics', alt: 'rfid nfc pn532 access control scanner tap', u: [E('Bike Lock','experiences/bike-lock.html')] },
